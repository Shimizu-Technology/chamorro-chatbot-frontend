...
export function QuickPhrases({ onSelect, disabled }: QuickPhrasesProps) {
  ...
  return (
    <div className="px-3 sm:px-4 py-3 bg-cream-50 dark:bg-gray-900/50 border-b border-cream-300 dark:border-gray-800">
      <div className="max-w-4xl mx-auto">
        <p className="text-xs font-medium text-brown-600 dark:text-gray-400 mb-2">Quick start:</p>
        ...
        <div className="flex sm:hidden gap-2 overflow-x-auto pb-1 -mx-3 px-3 scrollbar-hide snap-x snap-mandatory">
          {phrases.map((phrase, index) => (
            <button
              ...
              disabled={disabled}
              className="flex-shrink-0 w-40 px-3 py-2.5 text-xs bg-cream-100 dark:bg-gray-800 text-brown-700 dark:text-gray-300 border border-cream-300 dark:border-gray-700 rounded-xl hover:bg-teal-50 dark:hover:bg-ocean-950/30 hover:border-teal-300 dark:hover:border-ocean-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 text-left flex items-center gap-2 group snap-start"
            >
