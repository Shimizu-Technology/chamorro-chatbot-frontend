    ...
    <>
      ...
      <SignedOut>
        <SignInButton mode="modal">
          <button className="px-3 sm:px-4 py-2 bg-teal-500 hover:bg-teal-600 dark:bg-ocean-500 dark:hover:bg-ocean-600 text-white rounded-xl transition-all duration-200 text-sm font-medium shadow-sm hover:shadow-md active:scale-95">
            Sign In
          </button>
        </SignInButton>
      </SignedOut>
